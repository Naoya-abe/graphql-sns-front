...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'PostModel', id: string, content: string, userId: string, createdAt: any, updatedAt: any, user: { __typename?: 'UserModel', id: string, email: string, nickname: string, selfIntroduction: string, createdAt: any, updatedAt: any } } };
...
export type EditPostMutation = { __typename?: 'Mutation', editPost: { __typename?: 'PostModel', id: string, content: string, userId: string, createdAt: any, updatedAt: any, user: { __typename?: 'UserModel', id: string, email: string, nickname: string, selfIntroduction: string, createdAt: any, updatedAt: any } } };
...
export type DeletePostMutation = { __typename?: 'Mutation', deletePost: { __typename?: 'PostModel', id: string, content: string, userId: string, createdAt: any, updatedAt: any, user: { __typename?: 'UserModel', id: string, email: string, nickname: string, selfIntroduction: string, createdAt: any, updatedAt: any } } };
...
export type GetPostQuery = { __typename?: 'Query', post: { __typename?: 'PostModel', id: string, content: string, userId: string, createdAt: any, updatedAt: any, user: { __typename?: 'UserModel', id: string, email: string, nickname: string, selfIntroduction: string, createdAt: any, updatedAt: any } } };

export type PostAddedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type PostAddedSubscription = { __typename?: 'Subscription', postAdded: { __typename?: 'PostModel', id: string, content: string, userId: string, createdAt: any, updatedAt: any, user: { __typename?: 'UserModel', id: string, email: string, nickname: string, selfIntroduction: string, createdAt: any, updatedAt: any } } };
