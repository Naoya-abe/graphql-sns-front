...
const documents = {
    ...
    "mutation CreatePost($content: String!) {\n  createPost(createPostDto: {content: $content}) {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}\n\nmutation EditPost($postId: String!, $content: String!) {\n  editPost(editPostDto: {postId: $postId, content: $content}) {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}\n\nmutation DeletePost($postId: String!) {\n  deletePost(deletePostDto: {postId: $postId}) {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}": types.CreatePostDocument,
    "query GetPosts {\n  posts {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}\n\nquery GetPost($postId: String!) {\n  post(getPostByIdDto: {postId: $postId}) {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}": types.GetPostsDocument,
    "subscription PostAdded {\n  postAdded {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}": types.PostAddedDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "subscription PostAdded {\n  postAdded {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["subscription PostAdded {\n  postAdded {\n    id\n    content\n    userId\n    user {\n      id\n      email\n      nickname\n      selfIntroduction\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
